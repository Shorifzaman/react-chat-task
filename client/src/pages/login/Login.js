            ...
            <div className="_social_login_wrap">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="_social_login_content">
                        ...
                        <button type="button" onClick={handleGoogleSignIn} className="_social_login_content_btn _mar_b40">
                ...
                <form className="_social_login_form" onSubmit={handleLoginSubmit}>
                        <div className="row">
